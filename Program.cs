...
class Program
{
    ...
    {
        Console.WriteLine("\n");
        Car Indica1 = new Car("petrol", 6, "Indica", "perDay", 4000, 2.5, "MP-80K-4437", new DateTime(2021, 07, 23), false);
        Car Indica2 = new Car("diesel", 6, "Indica", "perDay", 3200, 0.5, "RJ-23SJ-3541", new DateTime(2022, 02, 11), false);
        Car Indica3 = new Car("diesel", 6, "Indica", "perKm", 1800, 3, "MH-11K-8271", new DateTime(2019, 08, 19), false);
        Car Indica4 = new Car("petrol", 6, "Indica", "perKm", 2100, 1.5, "GJ-01MN-9875", new DateTime(2022, 02, 09), false);

        Car Qualis1 = new Car("petrol", 8, "Qualis", "perDay", 1200, 2, "CH-96E-6547", new DateTime(2021, 12, 19), false);
        Car Qualis2 = new Car("diesel", 8, "Qualis", "perKm", 250, 1, "GJ-35K-5462", new DateTime(2022, 02, 11), false);
        Car Qualis3 = new Car("petrol", 8, "Qualis", "perDay", 1500, 2.5, "MH-87A-1987", new DateTime(2022, 02, 05), false);

        Car DavidHarley1 = new Car("DavidHarley", "perDay", 6000, 1.5, "GJ-01AM-6474", new DateTime(2021, 05, 11), false);

        Car MBenzEClass1 = new Car("MBenzEClass", "perKm", 1500, 2.5, "GJ-06KC-1784", new DateTime(2021, 03, 20), false);
        Car MBenzEClass2 = new Car("MBenzEClass", "perDay", 8000, 1, "DL-34E-8980", new DateTime(2020, 02, 05), false);
        ...
        qualis1.GiveForRent(new DateTime(2022, 02, 01), new DateTime(2022, 02, 18), 50);
